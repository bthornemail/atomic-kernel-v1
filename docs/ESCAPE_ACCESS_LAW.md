...
Status: Normative
Authority: Extension
Depends on: `docs/imports/folder1-v1_2/ESCAPE_ACCESS_LAW.md`, `docs/FORK_IMPORT_INDEX_v1_2.md`, `docs/PROMOTION_MATRIX_v1_2.md`, `docs/CHIRALITY_SELECTION_LAW_v0.md`, `docs/A14_INCIDENCE_SCHEDULING_LAW_v0.md`

Promotion Note: Canonical integration of Phase 1 candidate from import lane.
Boundary: Existing canonical authority model remains unchanged; this document is subject to explicit promotion governance.
...
### 22.5 Scheduling Eligibility Boundary (A14 Compatibility)

Escaped interpretation scopes may widen local interpretation, but they do not grant ordering authority.

Canonical incidence-response eligibility remains kernel-derived and chirality-derived:

- escape may expose additional candidate interactions,
- A5 + chirality determine lawful orientation/order,
- A14 determines when a candidate is eligible to respond,
- only lawful commit transitions mutate canonical state.

Therefore, escape cannot be used to force early response, rewrite past ordering, or promote pending future proposals to canonical fact.
